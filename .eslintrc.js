module.exports = {
  ...
  //   ecmaVersion: 12,
  // },
  ignorePatterns: ['lib/', 'src/stories'],
  rules: {
  ...
  // =================================
  overrides: [// Match TypeScript Files
    // =================================
    {
      files: ['**/*.{ts,tsx}'],
      ...
      extends: [// 'eslint:recommended',
        ...
        'plugin:@typescript-eslint/recommended', 'plugin:@typescript-eslint/recommended-requiring-type-checking', // 'plugin:import/errors',
